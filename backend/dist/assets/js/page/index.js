...
$(function () {
  ...
  $(document).ready(function () {
      ...
      series: [
        {
          name: "Purchase",
          data: [
            0.4, 0.65, 0.76, 0.88, 1.5, 2.1, 2.9, 4.1, 4.2, 4.5, 3.9, 3.5, 3,
          ],
        },
        {
          name: "Sell",
          data: [
            -0.8, -1.05, -1.06, -1.18, -1.4, -2.2, -4.4, -4.1, -4, -4.1, -3.4,
            -3.1, -2.8,
          ],
        },
      ],
    ...
    var chart = new ApexCharts(
      document.querySelector("#apex-GenderOverview"),
      options
    );
    chart.render();
  });
      ...
      series: [
        {
          name: "Costs",
          data: [
            1131, 1180, 1114, 1109, 1112, 1016, 1317, 1213, 1014, 1199, 1251,
          ],
        },
      ],
      chart: {
